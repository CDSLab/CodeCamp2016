...
6. Name your application and give a unique name to your **host**
...
7. Your application will start staging and will start. The app will have cloudant database by default to store node red metadata.
...
8. Click on the link of your application. You will be taken to **NODE-RED**
